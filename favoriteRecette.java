...
public class favoriteRecette extends AppCompatActivity {
    ListView liste;
    DatabaseRecettes db;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_favorite_recette);
        db=new DatabaseRecettes(getApplicationContext());

        liste=(ListView)findViewById(R.id.lv);

        ArrayList<String> li=db.tous_recetteFavorite("true");
